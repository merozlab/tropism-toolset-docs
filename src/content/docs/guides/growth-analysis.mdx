...
>
To perform growth analysis, you need the following experimental data:
  <DataItem
  ...
  <DataItem
    ...
    value="Frame number where the plant has reached gravitropic equilibrium for Lc fitting"
  />
</RequiredData>
